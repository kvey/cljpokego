...
var args32738 = [];
var len__7229__auto___32742 = arguments.length;
var i__7230__auto___32743 = (0);
while(true){
if((i__7230__auto___32743 < len__7229__auto___32742)){
args32738.push((arguments[i__7230__auto___32743]));

var G__32744 = (i__7230__auto___32743 + (1));
i__7230__auto___32743 = G__32744;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args32738.length)].join('')));
...
var G__32741 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__32741,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__32741;
}
});
...
var or__6154__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__7229__auto___32749 = arguments.length;
var i__7230__auto___32750 = (0);
while(true){
if((i__7230__auto___32750 < len__7229__auto___32749)){
args__7236__auto__.push((arguments[i__7230__auto___32750]));

var G__32751 = (i__7230__auto___32750 + (1));
i__7230__auto___32750 = G__32751;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__7237__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq32746){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__32747,G__32748,seq32746__$2);
});
...
var file = cljs.core.get.call(null,map__32755__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__32755__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__32755__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__32755,map__32755__$1,file,line,column){
return (function (p1__32752_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__32752_SHARP_));
});})(map__32755,map__32755__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__7079__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__7079__auto__,prefer_table__7080__auto__,method_cache__7081__auto__,cached_hierarchy__7082__auto__,hierarchy__7083__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__6154__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__6154__auto__)){
return or__6154__auto__;
} else {
...
var temp__4657__auto___32757 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___32757)){
var message_32758 = temp__4657__auto___32757;
cljs.core.println.call(null,message_32758);
} else {
}
...
var temp__4657__auto___32759 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___32759)){
var message_32760 = temp__4657__auto___32759;
cljs.core.println.call(null,message_32760);
} else {
}
...
var temp__4655__auto__ = (function (){var and__6142__auto__ = typeof exception.stack === 'string';
if(and__6142__auto__){
var G__32770 = exception.stack;
var G__32770__$1 = (((G__32770 == null))?null:clojure.string.split_lines.call(null,G__32770));
var G__32770__$2 = (((G__32770__$1 == null))?null:cljs.core.get.call(null,G__32770__$1,depth));
if((G__32770__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__32770__$2);
}
} else {
...
var vec__32771 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__32771,(0),null);
var column = cljs.core.nth.call(null,vec__32771,(1),null);
var vec__32774 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__32774,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__32774,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__32774,(2),null);
...
var m__$1 = (function (){var G__32778 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__32778) {
case "fail":
...
var G__32784 = (function (){var G__32783 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__32783);
} else {
return G__32783;
}
})();
...
return cljs.core.vary_meta.call(null,G__32786,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e32789){var e = e32789;
var G__32790 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__32790) {
...
var vec__32795 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__32795,(0),null);
var types = vec__32795;
...
return cljs.core.map.call(null,(function (p__32807){
var vec__32808 = p__32807;
var ns = cljs.core.nth.call(null,vec__32808,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__32808,(1),null);
return ((function (vec__32808,ns,vars__$1){
return (function (){
...
var G__32811 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__32811) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__32811,env,once_fixtures,each_fixtures,vec__32808,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__32811,env,once_fixtures,each_fixtures,vec__32808,ns,vars__$1){
return (function (){
var seq__32812 = cljs.core.seq.call(null,vars__$1);
var chunk__32813 = null;
var count__32814 = (0);
var i__32815 = (0);
while(true){
if((i__32815 < count__32814)){
var v = cljs.core._nth.call(null,chunk__32813,i__32815);
var temp__4657__auto___32817 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___32817)){
var t_32818 = temp__4657__auto___32817;
each_fixture_fn.call(null,((function (seq__32812,chunk__32813,count__32814,i__32815,t_32818,temp__4657__auto___32817,v,each_fixture_fn,G__32811,env,once_fixtures,each_fixtures,vec__32808,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_32818)));
});})(seq__32812,chunk__32813,count__32814,i__32815,t_32818,temp__4657__auto___32817,v,each_fixture_fn,G__32811,env,once_fixtures,each_fixtures,vec__32808,ns,vars__$1))
);
} else {
}
...
var c__6965__auto__ = cljs.core.chunk_first.call(null,seq__32812__$1);
var G__32823 = cljs.core.chunk_rest.call(null,seq__32812__$1);
var G__32824 = c__6965__auto__;
var G__32825 = cljs.core.count.call(null,c__6965__auto__);
var G__32826 = (0);
seq__32812 = G__32823;
...
var v = cljs.core.first.call(null,seq__32812__$1);
var temp__4657__auto___32827__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___32827__$1)){
var t_32828 = temp__4657__auto___32827__$1;
each_fixture_fn.call(null,((function (seq__32812,chunk__32813,count__32814,i__32815,t_32828,temp__4657__auto___32827__$1,v,seq__32812__$1,temp__4657__auto__,each_fixture_fn,G__32811,env,once_fixtures,each_fixtures,vec__32808,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_32828)));
});})(seq__32812,chunk__32813,count__32814,i__32815,t_32828,temp__4657__auto___32827__$1,v,seq__32812__$1,temp__4657__auto__,each_fixture_fn,G__32811,env,once_fixtures,each_fixtures,vec__32808,ns,vars__$1))
);
} else {
}

var G__32829 = cljs.core.next.call(null,seq__32812__$1);
var G__32830 = null;
var G__32831 = (0);
var G__32832 = (0);
seq__32812 = G__32829;
chunk__32813 = G__32830;
count__32814 = G__32831;
i__32815 = G__32832;
continue;
}
} else {
...
});})(each_fixture_fn,G__32811,env,once_fixtures,each_fixtures,vec__32808,ns,vars__$1))
);
});})(each_fixture_fn,G__32811,env,once_fixtures,each_fixtures,vec__32808,ns,vars__$1))
], null);
